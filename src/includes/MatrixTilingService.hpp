...
struct RowMajorTilingService
  ...
  constexpr RowMajorTilingService(TRangeRow const &trange_row,
                                  TRangeCol const &trange_col)
      : trange_row_(trange_row), trange_col_(trange_col) {}

  constexpr RowMajorTilingService(TRangeRow &&trange_row,
                                  TRangeCol &&trange_col)
      : trange_row_(std::move(trange_row)),
        trange_col_(std::move(trange_col)) {}
  ...
  constexpr RowMajorTilingService(RowMajorTilingService &&other) noexcept
      : trange_row_(std::move(other.trange_row_)),
        trange_col_(std::move(other.trange_col_)) {}
  ...
  friend std::ostream &operator<<(std::ostream &os,
                                  RowMajorTilingService const service) {
    os << "Row major tiling: row" << service.trange_row_ << ", col"
       << service.trange_col_;
    return os;
  }
};