...
TEST(TestLayout, Test2) {
    ...
    auto shape0 = layout.get_shape().dim[0_c];
    auto shape1 = layout.get_shape().dim[1_c];
    auto stride0 = layout.get_strides().dim[0_c];
    auto stride1 = layout.get_strides().dim[1_c];
